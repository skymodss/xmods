    ...
    return (
        <>
            <div className="min-h-screen">
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            <div className="z-10 space-y-6 lg:col-span-2">
                                <header className="!mt-0">
                                    <div className="rounded-3xl dark:bg-neutral-600 text-card-foreground shadow-sm bg-card/70 backdrop-blur-sm ">
							...
							>
                                ...
                                <section className="script-description">
                                    <div className="bg-card dark:bg-neutral-600 text-card-foreground shadow-sm rounded-3xl">
				...
				<section className="script-description">
                                    <div className="bg-card text-card-foreground shadow-sm dark:bg-neutral-600 rounded-3xl">
                                        <div className="flex flex-col space-y-1.5 p-6">
