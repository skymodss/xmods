...
const SingleType1: FC<SingleType1Props> = ({ post, showRightSidebar }) => {
    ...
    return (
		...
		<div class="absolute -top-[370px] hidden h-[50rem] w-full bg-gradient-to-b from-gray-200/40 to-white dark:from-muted/20 dark:to-background md:block"></div>
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            <div className="z-10 space-y-6 lg:col-span-2">
                                <header className="!mt-0">
                                    <div className="rounded-2xl dark:bg-neutral-600 text-card-foreground shadow-sm bg-card/70 backdrop-blur-sm ">
