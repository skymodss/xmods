    ...
    return (
        <>
            <div className="min-h-screen">
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            <div className="z-10 space-y-6 lg:col-span-2">
                                <header className="!mt-0">
                                    <div className="rounded-2xl bg-neutral-300 dark:bg-neutral-600 text-card-foreground bg-card/70 backdrop-blur-sm ">
							...
							>
                                ...
                                <section className="script-description">
                                    <div className="bg-neutral-300 dark:bg-neutral-600 text-card-foreground rounded-2xl">
				...
				<section className="script-description">
                                    <div className="bg-neutral-300 text-card-foreground dark:bg-neutral-600 rounded-2xl">
                                        <div className="flex flex-col space-y-1.5 p-6">
