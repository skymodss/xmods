				...
				<section className="script-description">
						...
						{tags?.nodes?.length ? (
                            ...
                            <aside className="script-similar-scripts lg:col-span-1">
                                <div className="rounded-2xl border text-card-foreground shadow-sm sticky top-15 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 lg:w-[400px] bg-[rgb(255,255,255)]">
