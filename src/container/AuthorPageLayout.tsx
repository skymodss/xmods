            ...
            {ncUserMeta?.backgroundImage?.node ? (
              <>
                ...
                <NcImage
                  ...
                  className="h-full w-full object-cover rounded-3xl blur-2xl scale-100"
                  aria-hidden
                  fill
                  priority
                />
                ...
                <NcImage
                  ...
                  sizes="(max-width: 1280px) 100vw, 1536px"
                  src={getImageDataFromImageFragment(ncUserMeta?.backgroundImage?.node).sourceUrl}
                  className="h-full w-full object-cover rounded-3xl border border-white/90 box-border shadow-xl shadow-black/40"
                  fill
                  priority
                />
              </>
            ) : (
              <div className="absolute inset-0 bg-neutral-200/70 rounded-3xl shadow-2xl" />
            )}
          </div>
        </div>
