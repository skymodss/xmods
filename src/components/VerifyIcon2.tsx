...
const VerifyIcon2: FC<VerifyIcon2Props> = ({
	...
	return (
		...
		>
			...
			<div
				className={`absolute bg-[rgb(255,255,255)] rounded-2xl border shadow-xl bg-card text-start text-neutral-900 transition-transform duration-200 dark:text-neutral-200 px-2 py-1 pl-[6px] pr-[6px] pt-[6px] pb-[6px] ${
			...
			>
				 <h2 className="flex-shrink-0 text-bold text-neutral-900 transition-colors duration-75 dark:text-neutral-200">{'Verified Creator'}</h2>
			</div>
		</span>
	);
};
