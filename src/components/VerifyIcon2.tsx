...
const VerifyIcon2: FC<VerifyIcon2Props> = ({
	...
	return (
		...
		>
			...
			<div
				className={`absolute bg-[rgb(255,255,255)] rounded-2xl border shadow-xl bg-card text-start text-neutral-900 transition-transform duration-200 dark:text-neutral-200 px-2 py-1 pl-[12px] pr-[12px] pt-[12px] pb-[12px] ${
