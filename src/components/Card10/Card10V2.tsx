	...
	return (
		...
		>
			<div className="group aspect-h-9 aspect-w-16 relative z-0 block w-full flex-shrink-0 overflow-hidden rounded-3xl sm:aspect-h-9">
				<div>
					<PostFeaturedMedia className="h-full w-full object-cover rounded-3xl opacity-50 blur-3xl scale-105" post={post} isHover={isHover} />
					<PostFeaturedMedia className="h-full w-full object-cover rounded-3xl" post={post} isHover={isHover} />
				</div>
