...
const MainNav2: FC<MainNav2Props> = ({ menuItems, description, title }) => {
	return (
		<div className="nc-MainNav3 relative z-10 border-b-1.5 border-neutral-200/70 bg-white/85 backdrop-blur-2xl dark:border-transparent dark:bg-neutral-900/85 dark:border-neutral-600">
			<div className="px-4 xl:container">
				<div className="flex h-16 justify-between sm:h-20">
					...
					<div className="hidden items-center gap-x-3 sm:gap-x-8 lg:flex">
						...
						<div className="hidden w-64 max-w-xs sm:block xl:w-80 dark:bg-neutral-600 rounded-2xl">
